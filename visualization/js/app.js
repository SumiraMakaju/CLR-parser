...
function initOrbs() {
  ...
  [{w:80,h:80,left:'7%',top:'10%',bg:'#f48fb1',dur:'4s',delay:'0s'},
   ...
   {w:40,h:40,left:'50%',top:'70%',bg:'#90caf9',dur:'7s',delay:'2s'}
    ...
    d.className = 'orb';
    d.style.cssText = `width:${o.w}px;height:${o.h}px;left:${o.left};top:${o.top};background:${o.bg};animation-duration:${o.dur};animation-delay:${o.delay};`;
    wrap.appendChild(d);
  });
}
...
document.addEventListener('DOMContentLoaded', () => {
  initOrbs();
  // Auto-parse the default string on load
  loadAndParse();
});